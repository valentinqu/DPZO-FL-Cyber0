...
# ==========================================
# 无 NNM 防御
file1 = r"D:\Visual Studio Code\TDLGroupProject\output\nnm\FOE\cnn_epsilon5.0_FOE_attacker4_a0.5.csv"
# 开启 NNM 防御
file2 = r"D:\Visual Studio Code\TDLGroupProject\output\nnm\FOE\cnn_epsilon5.0_FOE_attacker4_a0.5_nnm.csv"

# 论文图例中显示的专业名称
label1 = "FOE Attack (Trimmed Mean Only)"
label2 = "FOE Attack + NNM Defense"
